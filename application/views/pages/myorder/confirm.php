				...
				<?= form_open_multipart($form_action, ['method' => 'POST']) ?>
					...
					<div class="card-body">
						...
						<div class="form-group">
							...
							<input type="text" name="account_name" value="<?= $input->account_name?>" class="form-control" value="029929992">
							<?= form_error('account_name') ?>
						</div>
						<div class="form-group">
							<label for="">Nomor Rekening</label>
							<input type="text" name="account_number" value="<?= $input->account_number?>" class="form-control" value="029929992">
							<?= form_error('account_number') ?>
						</div>
						<div class="form-group">
							<label for="">Sebesar</label>
							<input type="number" name="nominal" value="<?= $input->nominal?>" class="form-control" value="450000">
							<?= form_error('nominal') ?>
						</div>
						<div class="form-group">
