		...
		<div class="col-md-10 mx-auto">
							...
							<table class="table">
								...
								<tbody>
									...
									<tr>
										...
										<td class="text-center"><b>RP <?= number_format(array_sum(array_column($order_detail, 'subtotal')), 0, ',', '.') ?>,-</b></td>
										<td></td>
									</tr>
								</tbody>
							</table>
			...
			<?php if(isset($order_confirm)) : ?>
				<div class="row mt-3">
                    ...
                    <div class="col-md-4">
                        <img src="<?= base_url("/images/confirm/$order_confirm->image") ?>" height="150" class="img-responsive">
                    </div>
                </div>
			<?php endif ?>
		</div>
