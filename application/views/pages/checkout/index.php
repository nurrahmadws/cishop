				...
				<div class="card-body">
					<form action="<?= base_url("/checkout/create")?>" method="POST">
						<div class="form-group">
							...
							<input type="text" name="name" value="<?= $input->name ?>" class="form-control" placeholder="Nama Penerima">
							<?= form_error('name') ?>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<input type="text" name="phone" value="<?= $input->phone ?>" class="form-control" placeholder="Nomor Handphone Penerima">
							<?= form_error('phone') ?>
						</div>
