...
class Profile extends MY_Controller 
{
	...
	{
		$data['title']	 = 'Profile';
		$data['content'] = $this->Profile_model->where('id', $this->id)->first();
	...
	public function update($id)
	{
		...
		if ($this->Profile_model->where('id', $id)->update($data['input'])) {
	...
	public function unique_email()
	{
		...
		$user	= $this->Profile_model->where('email', $email)->first();
