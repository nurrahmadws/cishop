...
class Checkout extends MY_Controller 
{
	...
	{
		$this->Checkout_model->table = 'cart';
		$data['cart'] = $this->Checkout_model->select([
		...
		$data['input'] = $input ? $input : (object) $this->Checkout_model->getDefaultValues();
		$data['title'] = 'Checkout';
	...
	public function create()
	{
		...
		if (!$this->Checkout_model->validate()) {
		...
		if ($order = $this->Checkout_model->create($data)) {
